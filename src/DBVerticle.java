...
public class DBVerticle extends AbstractVerticle {
    ...
    private void init() {
        JsonObject config = new JsonObject()
                .put("url", "jdbc:mysql://loaclhost:3306/wraptalk?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&autoReconnect=true&zeroDateTimeBehavior=convertToNull")
                .put("user", "root")
                .put("password", "12345678090")
